...
export default function FileUploader({ addedFile, onChange }: FileUploaderProps) {
  ...
  return (
      <div className="w-full mt-4">
        ...
        {addedFile ? (
          <div className="relative flex items-center p-4 border rounded mb-4 bg-gray-50 dark:bg-gray-900">
            ...
            >
              ...
              <div className="flex flex-col items-center m-0">
                ...
                <span className="text-center mb-4 block w-full max-w-md text-sm text-gray-700 dark:text-gray-400">
                  Drag and drop your PNG, JPG, WebP, SVG images or document files here or browse
                </span>
                <span className="font-medium underline text-sm text-red-500">
                  Browse File
                </span>
              </div>
            </div>
